            ...
            <div class="row mt-5">
                <div class="col-xl-12 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form>
                                <h6 class="heading-small text-muted mb-4">User Form</h6>
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-username" class="form-control form-control-alternative" v-model="user.email">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="input-username" class="form-control form-control-alternative" v-model="user.password">
